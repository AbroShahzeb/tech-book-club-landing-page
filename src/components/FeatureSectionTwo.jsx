...
export const FeatureSectionTwo = () => {
  return (
    <section className=" desktop:px-[135px] flex flex-col-reverse gap-500 desktop:gap-1000 desktop:items-center py-800 px-200 tablet:px-400 desktop:flex-row-reverse pb-0">
